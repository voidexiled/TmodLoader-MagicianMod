...
namespace MagicianClass.Content.DamageClasses;

public class TrickeryDamage : DamageClass
{
    ...
    public override void SetDefaultStats(Player player)
    {
        ...
        player.GetCritChance<TrickeryDamage>() += 4;
        player.GetArmorPenetration<TrickeryDamage>() += 10;
